...
public class CometTouchGestureListener_GestureDetectorListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Comet.Android.Controls.CometTouchGestureListener+GestureDetectorListener, Comet", CometTouchGestureListener_GestureDetectorListener.class, __md_methods);
	}


	public CometTouchGestureListener_GestureDetectorListener ()
	{
		super ();
		if (getClass () == CometTouchGestureListener_GestureDetectorListener.class)
			mono.android.TypeManager.Activate ("Comet.Android.Controls.CometTouchGestureListener+GestureDetectorListener, Comet", "", this, new java.lang.Object[] {  });
	}
